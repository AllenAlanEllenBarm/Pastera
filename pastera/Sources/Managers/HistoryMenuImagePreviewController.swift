...
final class HistoryMenuTextPreviewController {
    private enum Metrics {
        static let size = NSSize(width: 320, height: 126)
    ...
    private func makeContentView() -> NSView {
        ...
        NSLayoutConstraint.activate([
            textLabel.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: Metrics.contentInset),
            textLabel.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -Metrics.contentInset),
            textLabel.topAnchor.constraint(equalTo: contentView.topAnchor, constant: Metrics.contentInset),
            textLabel.bottomAnchor.constraint(lessThanOrEqualTo: contentView.bottomAnchor, constant: -Metrics.contentInset)
        ])
