...
- Plan Status：`implementation-in-progress-task-9-preflight`
...
- Follow-ups：继续按已选择的 Subagent-Driven 流程顺序实施 Task 10–12，并持续更新本文件复选框与 Delivery Record；Task 10 接入 Agent 集成偏好页、一次授权体验和独立 Host 权限选择，同时保持当前安装事务与授权边界。
