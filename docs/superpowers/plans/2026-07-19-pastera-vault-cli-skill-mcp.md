...
- Follow-ups：继续按已选择的 Subagent-Driven 流程顺序实施 Task 9–12，并持续更新本文件复选框与 Delivery Record；Task 9 在现有 Host/Helper 身份模型上实现规范 Skill、原子所有权清单、官方 CLI 注册与可逆窄权限能力。
